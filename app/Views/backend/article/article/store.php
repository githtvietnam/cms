					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="form-row">
									<?php echo form_dropdown('catalogueid', $dropdown, set_value('catalogueid', (isset($article['catalogueid'])) ? $article['catalogueid'] : ''), 'class="form-control m-b select2 '.$class.'" data-module="'.$module.'"');?>
								</div>
