				...
				<div class="ibox ibox-seo mb20">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<?php  
									$metaTitle = (isset($_POST['meta_title'])) ? $_POST['meta_title'] : ((isset($article_catalogue['meta_title']) && $article_catalogue['meta_title'] != '') ? $article_catalogue['meta_title'] : 'Bạn chưa nhập tiêu đề SEO cho bài viết') ;
									...
									$metaDescription = (isset($_POST['meta_description'])) ? $_POST['meta_description'] : ((isset($article_catalogue['meta_description']) && $article_catalogue['meta_description'] != '') ? $article_catalogue['meta_description'] : 'Bạn Chưa nhập mô tả SEO cho bài viết') ;
								?>
								<div class="google">
