					...
					<div class="ibox-content">
						<?php
							if(isset($_POST['album'])){
								...
								$album = json_decode($attribute['album'], TRUE);
							}
						...
						<div class="row">
							<div class="col-lg-12">
								<?php  
									...
									$googleLink = (isset($_POST['canonical'])) ? $_POST['canonical'] : ((isset($attribute['canonical']) && $attribute['canonical'] != '') ? BASE_URL.$attribute['canonical'].HTSUFFIX : BASE_URL.'duong-dan-website'.HTSUFFIX) ;
									...
									<div class="form-row">
										...
										<div class="outer">
											<div class="uk-flex uk-flex-middle">
												...
												<?php echo form_input('canonical', htmlspecialchars_decode(html_entity_decode(set_value('canonical', (isset($attribute['canonical'])) ? $attribute['canonical'] : ''))), 'class="form-control canonical" placeholder="" autocomplete="off" data-flag="0" ');?>
												<?php echo form_hidden('original_canonical', htmlspecialchars_decode(html_entity_decode(set_value('canonical', (isset($attribute['canonical'])) ? $attribute['canonical'] : ''))), 'class="form-control canonical" placeholder="" autocomplete="off"');?>
				...
				<div class="ibox mb20">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<div class="form-row">
									<div class="avatar" style="cursor: pointer;"><img src="<?php echo (isset($_POST['image'])) ? $_POST['image'] : ((isset($attribute['image']) && $attribute['image'] != '') ? $attribute['image'] : 'public/not-found.png') ?>" class="img-thumbnail" alt=""></div>
									<?php echo form_input('image', htmlspecialchars_decode(html_entity_decode(set_value('image', (isset($attribute['image'])) ? $attribute['image'] : ''))), 'class="form-control " placeholder="Đường dẫn của ảnh"  id="imageTxt"  autocomplete="off" style="display:none;" ');?>
								</div>
							</div>
						</div>
					</div>
