...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      ...
      <ol class="breadcrumb" style="margin-bottom:10px;">
         ...
         <li class="active"><strong>Quản lý vị trí</strong></li>
      </ol>
   </div>
</div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="uk-flex uk-flex-middle">
                        <h5 class="mb0">Quản lý vị trí </h5>
                        <div class="uk-button ml20">
                            <a href="<?php echo base_url('backend/location/catalogue/index') ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> QL Nhóm vị trí</a>
                        </div>
                    </div>
                    <div class="ibox-tools">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li><a href="#" class="status" data-value="0" data-field="publish" data-module="<?php echo $module; ?>" title="Cập nhật trạng thái vị trí">Deactive vị trí</a>
                            </li> 
                            <li><a href="#" class="status" data-value="1" data-field="publish" data-module="<?php echo $module; ?>" data-title="Cập nhật trạng thái vị trí">Active vị trí</a>
                            </li>
                        </ul>
                        <a class="close-link">
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/location/location/create') ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Thêm vị trí mới</a>
                                    </div>
                                </div>
                            </div>
                        </div>
