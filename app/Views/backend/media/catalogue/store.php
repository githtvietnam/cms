				...
				<div class="ibox ibox-seo mb20">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<?php  
									$metaTitle = (isset($_POST['meta_title'])) ? $_POST['meta_title'] : ((isset($media_catalogue['meta_title']) && $media_catalogue['meta_title'] != '') ? $media_catalogue['meta_title'] : 'Bạn chưa nhập tiêu đề SEO cho Media') ;
									...
									$metaDescription = (isset($_POST['meta_description'])) ? $_POST['meta_description'] : ((isset($media_catalogue['meta_description']) && $media_catalogue['meta_description'] != '') ? $media_catalogue['meta_description'] : 'Bạn Chưa nhập mô tả SEO cho Media') ;
								?>
								<div class="google">
