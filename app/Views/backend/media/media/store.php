							...
							<div class="col-lg-12">
								<div class="form-row">
									<label class="control-label text-left">
										<span>Tiêu đề Media <b class="text-danger">(*)</b></span>
									</label>
				...
				<div class="ibox ibox-seo mb20">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<?php  
									$metaTitle = (isset($_POST['meta_title'])) ? $_POST['meta_title'] : ((isset($media['meta_title']) && $media['meta_title'] != '') ? $media['meta_title'] : 'Bạn chưa nhập tiêu đề SEO cho Media') ;
									...
									$metaDescription = (isset($_POST['meta_description'])) ? $_POST['meta_description'] : ((isset($media['meta_description']) && $media['meta_description'] != '') ? $media['meta_description'] : 'Bạn Chưa nhập mô tả SEO cho Media') ;
								?>
								<div class="google">
