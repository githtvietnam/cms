			...
			<div class="uk-grid uk-grid-medium uk-clearfix">
				...
				<div class="uk-width-large-3-4">
					<div class="article-panel">
						...
						<p class="article-content"><?php echo check_isset($object['content']); ?></p>
										...
										<li>
											<article class="article">
												<div class="thumb mb15">
													<a class="image img-cover img-flash" href="<?php echo check_isset($val['canonical']); ?>" title="<?php echo check_isset($val['title']); ?>"><img src="<?php echo check_isset($val['avatar']); ?>" alt="<?php echo check_isset($val['title']); ?>"></a>
												</div>
												<div class="infor">
