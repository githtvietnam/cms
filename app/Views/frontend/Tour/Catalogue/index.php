		...
		<div class="tourList">
			<div class="uk-grid uk-grid-medium uk-clearfix">
				<div class="uk-width-large-1-4 uk-visible-large">
					<?php echo view('frontend/homepage/common/asidetour') ?>
				</div>
											...
											<div class="infor uk-flex">
												<div class="wrap-content-tour mr50">
													...
													<div class="wrap-price isprice">
														<span class="old"><?php echo number_format(check_isset($value['price']),0,',','.') ?> đ</span>
														<span class="new"><?php echo (check_isset($value['price_promotion']) == '') ? number_format(check_isset($value['price']),0,',','.') : number_format(check_isset($value['price_promotion']),0,',','.')  ?> đ</span>
													</div>
												</div>	
												<div class="order">
