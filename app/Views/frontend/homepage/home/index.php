<div class="bg-video-hd">
	<video loop autoplay>
		<source src="public/frontend/resources/img/bg/city.mp4" type="video/mp4">
	</video>

	<div class="hd-content-panel">
		<div class="uk-container uk-container-center">
			<?php echo view('frontend/homepage/common/header-home') ; ?>
		</div>
	</div>
</div>
<?php 
	$home = array(
		0 => array(
			'img-1' => 'public/frontend/resources/img/upload/company-1.jpg',
			'img-2' => 'public/frontend/resources/img/upload/company-2.jpg',
			'img-3' => 'public/frontend/resources/img/upload/company-3.jpg',
		...
		1 => array(
			'img-1' => 'public/frontend/resources/img/upload/company-4.jpg',
			'img-2' => 'public/frontend/resources/img/upload/company-5.jpg',
			'img-3' => 'public/frontend/resources/img/upload/company-6.jpg',
		...
		2 => array(
			'img-1' => 'public/frontend/resources/img/upload/product-1-1.jpg',
			'img-2' => 'public/frontend/resources/img/upload/product-1-2.jpg',
			'img-3' => 'public/frontend/resources/img/upload/product-1-3.jpg',
		...
		3 => array(
			'img-1' => 'public/frontend/resources/img/upload/product-1-4.jpg',
			'img-2' => 'public/frontend/resources/img/upload/product-1-5.jpg',
			'img-3' => 'public/frontend/resources/img/upload/product-2-1.jpg',
		...
		4 => array(
			'img-1' => 'public/frontend/resources/img/upload/product-1-3.jpg',
			'img-2' => 'public/frontend/resources/img/upload/product-1-5.jpg',
			'img-3' => 'public/frontend/resources/img/upload/product-2-1.jpg',
		...
		5 => array(
			'img-1' => 'public/frontend/resources/img/upload/product-1-2.jpg',
			'img-2' => 'public/frontend/resources/img/upload/product-1-3.jpg',
			'img-3' => 'public/frontend/resources/img/upload/product-2-3.jpg',
		...
		6 => array(
			'img-1' => 'public/frontend/resources/img/upload/room-1-5.jpg',
			'img-2' => 'public/frontend/resources/img/upload/product-1-5.jpg',
			'img-3' => 'public/frontend/resources/img/upload/product-2-1.jpg',
		...
		7 => array(
			'img-1' => 'public/frontend/resources/img/upload/room-1-4.jpg',
			'img-2' => 'public/frontend/resources/img/upload/product-1-5.jpg',
			'img-3' => 'public/frontend/resources/img/upload/product-2-1.jpg',
		...
		8 => array(
			'img-1' => 'public/frontend/resources/img/upload/room-1-2.jpg',
			'img-2' => 'public/frontend/resources/img/upload/product-1-5.jpg',
			'img-3' => 'public/frontend/resources/img/upload/product-2-1.jpg',
		...
		9 => array(
			'img-1' => 'public/frontend/resources/img/upload/room-1-1.jpg',
			'img-2' => 'public/frontend/resources/img/upload/product-1-5.jpg',
			'img-3' => 'public/frontend/resources/img/upload/product-2-1.jpg',
...
<section class="all-product-panel">
	<div class="hd-filter">
		<div class="uk-container uk-container-center">
			<?php echo view('frontend/homepage/common/filter') ; ?>
				...
				<ul class="tabs-content">
					<li id="tab-1" class="tab-content current">
						<div class="uk-grid uk-grid-medium uk-grid-width-small-1-1 uk-grid-width-medium-1-2 uk-grid-width-large-1-3 uk-clearfix">
							<?php echo view('frontend/homepage/common/product') ; ?>
						</div>
					</li>
					<div class="loading">
						<img src="public/frontend/resources/img/icon/ajax-loader (1).gif" alt="">
					</div>
...
<?php 
	$agent = array(
		0 => array(
			'img-1' => 'public/frontend/resources/img/upload/testi-1.jpg',
			'name' => 'Adam Jarod',
		...
		1 => array(
			'img-1' => 'public/frontend/resources/img/upload/testi-2.jpg',
			'name' => 'Truman Kenithit',
			'text' => 'We went down the lane, by the body of the man in black, sodden now from the overnight hail, and broke into the woods at the foot of the hill.',
			'email' => 'truman.kennith@tangibledesign.net',
		),
		2 => array(
			'img-1' => 'public/frontend/resources/img/upload/testi-3.jpg',
			'name' => 'Deniella Senior',
			'text' => 'We went down the lane, by the body of the man in black, sodden now from the overnight hail, and broke into the woods at the foot of the hill.',
			'email' => 'daniella.suzanne@tangibledesign.net ',
		),
		3 => array(
			'img-1' => 'public/frontend/resources/img/upload/testi-4.jpg',
			'name' => 'Vladimir Putin',
			'text' => 'We went down the lane, by the body of the man in black, sodden now from the overnight hail, and broke into the woods at the foot of the hill.',
		...
		<div class="owl-slide">
			<div class="owl-carousel owl-theme" data-owl="<?php echo base64_encode(json_encode($owlInit)); ?>" data-disabled="0">
				<div class="wrap-blog ">
					<div class="img-product">
						<a href="" class="img-cover">
							<img src="public/frontend/resources/img/upload/city-1.jpg" alt="">
						</a>
						<div class="for-rent">
							September 30, 2017
						</div>
				...
				<div class="wrap-blog ">
					<div class="img-product">
						<a href="" class="img-cover">
							<img src="public/frontend/resources/img/upload/city-2.jpg" alt="">
						</a>
						<div class="for-rent">
							September 30, 2017
						</div>
				...
				<div class="wrap-blog ">
					<div class="img-product">
						<a href="" class="img-cover">
							<img src="public/frontend/resources/img/upload/city-3.jpg" alt="">
						</a>
						<div class="for-rent">
							September 30, 2017
						</div>
				...
				<div class="wrap-blog ">
					<div class="img-product">
						<a href="" class="img-cover">
							<img src="public/frontend/resources/img/upload/room-1-4.jpg" alt="">
						</a>
						<div class="for-rent">
							September 30, 2017
						</div>
				...
				<div class="wrap-product ">
					<div class="img-product">
						<div class="owl-slide">
							<div class="owl-carousel owl-theme" data-owl="<?php echo base64_encode(json_encode($owlInit)); ?>" data-disabled="0">
								<a href="" class="img-cover">
									<img src="public/frontend/resources/img/upload/company-1.jpg" alt="">
								</a>
								<a href="" class="img-cover">
									<img src="public/frontend/resources/img/upload/company-2.jpg" alt="">
								</a>
								<a href="" class="img-cover">
									<img src="public/frontend/resources/img/upload/company-3.jpg" alt="">
								</a>
							</div>
						</div>
						<a href="#modal-signin" class="btn-heart btn-modal-general">
			...
			<div class="owl-carousel owl-theme" data-owl="<?php echo base64_encode(json_encode($owlInit)); ?>" data-disabled="0">
				<div class="wrap-img-logo">
					<a href="" class="img-scaledown">
						<img src="public/frontend/resources/img/logo/audiojungle.webp" alt="">
					</a>
				</div>
				<div class="wrap-img-logo">
					<a href="" class="img-scaledown">
						<img src="public/frontend/resources/img/logo/codecanyon.webp" alt="">
					</a>
				</div>
				<div class="wrap-img-logo">
					<a href="" class="img-scaledown">
						<img src="public/frontend/resources/img/logo/graphicriver.webp" alt="">
					</a>
				</div>
				<div class="wrap-img-logo">
					<a href="" class="img-scaledown">
						<img src="public/frontend/resources/img/logo/photodune.webp" alt="">
					</a>
				</div>
				<div class="wrap-img-logo">
					<a href="" class="img-scaledown">
						<img src="public/frontend/resources/img/logo/themeforest.webp" alt="">
					</a>
				</div>
			</div>
		</div>
